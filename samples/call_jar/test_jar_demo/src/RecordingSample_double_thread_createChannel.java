...
public class RecordingSample implements RecordingEventHandler{
    ...
    public static void main(String[] args) {
        ...
        String[] args1 = new String[] {"--appId","yourAppid","--uid","0",
                "--channel","myrobot","--appliteDir",relativelyPath+"/libs", "--triggerMode","1"
        };
        String[] args2 = new String[] {"--appId","yourAppid","--uid","0",
                "--channel","myrobot","--appliteDir",relativelyPath+"/libs", "--triggerMode","1"
        };
