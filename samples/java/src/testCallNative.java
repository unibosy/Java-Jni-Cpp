...
class AgoraJavaRecording extends Thread{
  ...
  private Vector<Long> m_peers = new Vector<Long>();
  private long mNativeHandle = 0;
  private RecordingConfig config2;
  ...
  private void stopCallBack() {
    System.out.println("\n [WARNN] Java layer receive stop from JNI!Please type anything to exit!\n");
    stopped = true;
  }
  ...
  public AgoraJavaRecording(String appId, String channelKey, String channel, int uid, RecordingConfig config){
    this.appId2=appId;
    this.channelKey2 = channelKey;
  ...
  public static void main(String[] args) 
  {
    ...
    AgoraJavaRecording[] ars = new AgoraJavaRecording[2];
    ars[0] = new AgoraJavaRecording(appId,channelKey,name,uid,config); 
    ars[1] = new AgoraJavaRecording(appId,channelKey,"myrobot2",uid,config); 

    Thread arsThread1 = new Thread(ars[0]);
    arsThread1.start();
    ...
    Thread arsThread2 = new Thread(ars[1]);
    arsThread2.start();
