        ...
        while(true) {
            ...
            try{
                ...
                if(count>10){
                    change_count++;
                    if(change_count == 2) {
                        System.out.println("ars[1] to stop ars[0]");
                        ars[0].stopService(ars[1].mNativeHandle);

                        System.out.println("ars[1] to stop ars[0] -1");
                        //Thread.currentThread().sleep(1000);//sleep 1s

                        System.out.println("ars[1] to start ars[0]");
                        ars[0].startService(ars[1].mNativeHandle);
                        System.out.println("ars[1] to start ars[0] -1");
                        print_count++;
                        System.out.println("stop start count:"+print_count);
                        count = 0;
                    }else{
